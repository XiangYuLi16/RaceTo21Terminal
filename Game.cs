    ...
    public class Game
    {
        ...
        public void DoNextTask()
        {
            ...
            else if (nextTask == Task.PlayerTurn)
            {
                ...
                {
                    if (cardTable.OfferACard(player)) // Ask if the player wants a card
                    {
                        int cardsToDraw = cardTable.AskNumberOfCards(player); // Ask how many cards
                        ...
                        CheckPlayerStatus(player); // Check for bust or win
                    }
                    else
                    {
                        player.status = PlayerStatus.stay; // Player chooses to stay
                    }
                }
